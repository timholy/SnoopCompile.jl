...
@testset "bot" begin
    ...
    @testset "precompile new_includer_file" begin
        ...
        @testset "no os, no else_os, yes version, no else_version" begin
            ...
            elseif !ismultios && !ismultiversion
                ...
                @static if v"1.2.0" <= VERSION <= v"1.2.9"
    ...
    @testset "snoop_bot_multiversion" begin
        ...
        @test isfile("$(package_rootpath[3])/deps/SnoopCompile/precompile/$VERSION/precompile_TestPackage3.jl")

        precompile_text = Base.read("$(package_rootpath[3])/deps/SnoopCompile/precompile/$VERSION/precompile_TestPackage3.jl", String)
